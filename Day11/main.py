...
api = "<Your API from open weather>"
parameter = {
    'lat': 27.717245,  #latittude of kathmandu city
    'lon': 85.323959, #longitude of kathmandu city.
    'appid':api,
    'cnt':4,
    'units':'metric'
}
...
message = client.messages.create(
    from_='<virutal number provided by twilio>',
    body=sms,
...
# link for python anywhere: https://www.pythonanywhere.com